...
@section('content')
    <section class="container">
        <div class="row justify-content-center">
            <h1 class="py-5">Add A New Employee To System</h1>
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7">
                    <form name="setMessage" action="{{ route('employees.store') }}" method="POST" id="contactForm" novalidate="novalidate">
                        {{ csrf_field() }}
                        <!-- Name -->
                        ...
                        <!-- Address -->
                        <div class="form-floating mb-3">
                            <input class="form-control" value="" id="address" name="address" type="text"
                        ...
                        <!-- Email -->
                        <div class="form-floating mb-3">
                            <input class="form-control" value="" id="email" name="email" type="text" placeholder="Email"
                        ...
                        <!-- Phone -->
                        <div class="form-floating mb-3">
                            <input class="form-control" value="" id="phone" name="phone" type="text" placeholder="Phone"
                                data-sb-validations="required" />
                            <label>Phone</label>
                        ...
                        <!-- PESEL -->
                        <div class="form-floating mb-3">
                            <input class="form-control" value="" id="pesel" name="pesel" type="text" placeholder="PESEL"
                                data-sb-validations="required" />
                            <label>PESEL</label>
                            <div class="invalid-feedback" data-sb-feedback="total:required">Enter the employee's
                                PESEL
                        ...
                        <!-- Date -->
                        <div class="form-floating mb-3">
                            <input class="form-control" value="" id="date" name="date" type="text" placeholder="Date: Year-Month-Day"
                                data-sb-validations="required" />
